...
export default function StatesPage() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["states", page, debouncedSearch, sortBy, sortOrder],
        queryFn: () => stateService.getStates({ page, limit, search: debouncedSearch, sortBy, sortOrder }),
    })
                ...
                <Table className="min-w-[860px] border-0">
                    <TableHeader>
                        <TableRow className="border-0 bg-primary hover:bg-primary">
                            <TableHead className="font-semibold text-primary-foreground"><SortableColumnHeader label="State Name" field="stateName" sortBy={sortBy} sortOrder={sortOrder} onSort={handleSort} /></TableHead>
                            <TableHead className="font-semibold text-primary-foreground">Country</TableHead>
                            <TableHead className="font-semibold text-primary-foreground"><SortableColumnHeader label="GST Alias" field="gstAlias" sortBy={sortBy} sortOrder={sortOrder} onSort={handleSort} /></TableHead>
                            <TableHead className="text-center font-semibold text-primary-foreground">UT</TableHead>
