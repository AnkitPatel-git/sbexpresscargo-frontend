...
const headerNavItems = [
  ...
  { href: "/report/air-surface-batch", label: "Air/Surface Batch Report" },
          ...
          <div className="mt-1 flex flex-col gap-0.5 rounded-md bg-white p-1 shadow-sm">
            ...
            <PermissionGuard permission="report.billing_mis.read">
              <LinkItem
                ...
                active={isActive("/report/billing-mis")}
                icon={ClipboardList}
                showTextOverride
                inFlyout
              >
            ...
            <PermissionGuard permission="report.operations_mis.read">
              <LinkItem
                href="/report/operations-mis"
                active={isActive("/report/operations-mis")}
                icon={ClipboardList}
                showTextOverride
                inFlyout
              >
                Operations MIS Report
              </LinkItem>
            </PermissionGuard>
            ...
            <PermissionGuard permission="report.air_surface_batch.read">
              <LinkItem
                href="/report/air-surface-batch"
                active={isActive("/report/air-surface-batch")}
                icon={ClipboardList}
                showTextOverride
                inFlyout
              >
                Air/Surface Batch Report
              </LinkItem>
            </PermissionGuard>
