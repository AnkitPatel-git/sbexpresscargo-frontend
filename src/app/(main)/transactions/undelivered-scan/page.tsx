  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Undelivered Scans</h1>
          <p className="text-muted-foreground">Log and manage undelivered packages.</p>
        </div>
        <PermissionGuard permission="transaction.undelivered-scan.create">
          <Button onClick={() => router.push("/transactions/undelivered-scan/create")}>
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                data?.data.map((scan: UndeliveredScan) => (
